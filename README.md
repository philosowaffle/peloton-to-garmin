...
**Strava Tag:** _#StravaToGarmin_

Sync your Strava workouts to Garmin.

* Fetch latest workouts from Peloton
  * Run, Bike and more
* Automatically upload your workout to Garmin
* Convert Strava workouts to a variety of formats for offline backup
...
# Acknowlegement
Based on [peloton-to-garmin](https://github.com/philosowaffle/peloton-to-garmin) by [Bailey Belvis](https://github.com/philosowaffle)
