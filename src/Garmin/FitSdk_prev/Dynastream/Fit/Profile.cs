...
namespace Dynastream.Fit
{
    ...
    public static class Profile
    {
        ...
        private static Mesg CreateWorkoutStepMesg()
        {
            ...
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(3, 4);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatSteps", 134, 1, 0, ""));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 6);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatTime", 134, 1000, 0, "s"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 7);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatDistance", 134, 100, 0, "m"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 8);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatCalories", 134, 1, 0, "calories"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 9);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatHr", 134, 1, 0, "% or bpm"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 10);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 11);
            subfieldIndex++;
            newMesg.FieldsList[fieldIndex].subfields.Add(new Subfield("SecondaryTargetRepeatPower", 134, 1, 0, "% or watts"));
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 12);
            newMesg.FieldsList[fieldIndex].subfields[subfieldIndex].AddMap(1, 13);
            subfieldIndex++;
