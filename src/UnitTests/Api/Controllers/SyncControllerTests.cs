...
namespace UnitTests.Api.Controllers
{
	public class SyncControllerTests
	{
		...
		public async Task SyncAsync_WorkoutIds_Calls_CorrectMethod()
		{
			...
			service.Verify(s => s.SyncAsync(It.IsAny<ICollection<string>>(), null, false, false), Times.Once);
		}
		...
		public async Task SyncAsync_When_Service_Throws_Exception_Returns_BadRequest()
		{
			...
			service.Setup(s => s.SyncAsync(It.IsAny<ICollection<string>>(), null, false, false))
